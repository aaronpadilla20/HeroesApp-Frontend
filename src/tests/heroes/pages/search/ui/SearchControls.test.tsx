...
const renderWithRouter = (initiralEntries: string[] = ['/']) => {

    return render(
        <MemoryRouter initialEntries={initiralEntries} >
            <SearchControls />
        </MemoryRouter>
    )
}
...
describe('SearchControls', () => {
    ...
    test('should set input value when search param name is set', () => {
        ...
        const input = screen.getByPlaceholderText('Busca heroes, villanos, poderes, equipos...');
    ...
    test('should change params strenght when slider changed', () => {
