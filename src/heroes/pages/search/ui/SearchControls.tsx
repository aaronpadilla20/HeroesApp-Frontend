...
export const SearchControls = () => {
    ...
    const { name, activeAccordion, selectedStrength, setSearchParams } = useCustonSearchParams();

    const handleKeyDown = (event: React.KeyboardEvent<HTMLInputElement>) => {
        if (event.key === 'Enter') {
            setQueryParams('name', inputRef.current?.value ?? name)
        }
    }
        ...
        <>
            <div className="flex flex-col lg:flex-row gap-4 mb-8">
                ...
                <div className="relative flex-1">
                    ...
                    <Input
                        ref={inputRef}
                        placeholder="Busca heroes, villanos, poderes, equipos..."
